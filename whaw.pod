...
L<http://notanumber.net>

=head1 getting it

=over

=item a github mirror of releases is at L<http://github.com/johnmeacham/whaw>

=item the homepage for whaw is L<http://repetae.net/john/computer/whaw>

=item you can download it at L<http://repetae.net/john/computer/whaw/drop>

=item the darcs repository is at L<http://repetae.net/john/repos/whaw>

=item the changelog is at L<http://repetae.net/john/computer/whaw/Changelog.txt>
